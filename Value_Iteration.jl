...
# ╔═╡ d8a91840-b0d0-11ed-1c92-4b3fb2430646
begin
	using PlutoUI
	using Plots
	using Images
...
# ╔═╡ 8a5e055d-3362-4476-8275-78841c4492df
# Value Iteration
	...
	for i in 2:m+1
		for j in 2:n+1
			if Grid_Map[i,j] != 0
			    ...
			    new_Value_List[Grid_Map[i,j]] = discounting*sum(Direction_Vec.*Value_Vec)+reward
			end
		end
	end
...
# ╔═╡ a3c7309d-c4f9-4555-bdbb-4fb7efc90289
# Plan Route
...
# ╔═╡ a3626aa2-c54c-4724-9991-b5b8c78c3892
# Show RGB Result
...
# ╔═╡ dc8e5450-b666-47f9-9c89-7df693bee914
...
# ╔═╡ 90e7866d-841f-4426-a038-aba0949d215a
...
# ╔═╡ ee30ed37-9289-4ac4-a446-0340bde2d610
# Generate Map
...
# ╔═╡ b521dac2-be72-4684-a696-6e3374b8b801
# Generate Grid_World
begin
	m, n, p1, p2= 20, 20, 200, 6 # row, column, block index (the range of random), number of trap
	Grid_List, Block_List, Trap_List, start, finish, Grid_Map = Generate_Map(m,n,p1,p2)
	img=show_RGB(Grid_List, Trap_List, start, finish, m, n)
end

# ╔═╡ d617f182-df8b-4dee-bb08-532e0cddffbe
# Generate Value Map
begin
...
# ╔═╡ 11e22fc8-a71c-481c-8af7-d4539a14c4be
# Generate Route
begin
	Route_Optimization(Grid_Map,Value_List,start,finish,m,n,img)
end

# ╔═╡ 53888eac-544d-46d1-84e9-144c392ee91b
function step(x)
	if x>0
		return 1.0
	else
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "aded06a8cf2fdd999a7ebf824d088bdfdda6f885"
